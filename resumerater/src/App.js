...
function App() {
  ...
  return (
    <div className="App">
      ...
      {descriptionChangeOn && <div style={{fontSize:"50px",backgroundColor:"red", zIndex: 2, position: "absolute", top: "300px", left: "50%", padding:"30px", transform: "translate(-50%, -50%)", borderRadius:"10%", border:"5px solid gray", opacity:"0.9"}}><div style={{top:"0px",bottom:"50%",left:"0px",right:"50px",display:"inline"}}>Change Description?</div><button onClick={handleDescChangeClose} style={{top:"0px",bottom:"50%",height:"30px",width:"30px"}}>❌</button><br></br><textarea style={{width:"80%"}} value={descChangeText} onChange={handleDescChange} /><button style={{height:"30px",width:"30px"}} onClick={handleDescChangeSubmit}>✅</button></div>}
